...
\subsection*{Anleitung}
      ...
      File mit dem Namen \osuefilename{[ursprüngliches File].comp}
      ausgeben. Wird kein File übergeben, so ist von stdin zu
      lesen und in das File \osuefilename{Stdin.comp} auszugeben. Die
...
\subsection*{Testen}
      ...
      soll eine Testdatei \osuefilename{Test.txt} mit folgenden Inhalt:
