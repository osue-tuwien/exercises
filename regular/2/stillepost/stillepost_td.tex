...
Parameter auf. Beispiel: \osuecmd{stillepost \char`"OSUE macht
Spass.\char`"}
...
Der Mutterprozess soll seine Kinder mittels \osuefunc{fork(2)}
...
\begin{osuefmtcode}
$ \osueinput{./stillepost -v "OSUE macht Spass."}
