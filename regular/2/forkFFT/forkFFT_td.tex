...
The input of the program are float values, which should be read from \osueglvar{stdin}.  The number of rows might not be fixed! Each value is represented in a new line.
\subsection*{Examples}
constant signal:
\begin{verbatim}
$ ./forkFFT
